  ...
  Failure getFailure() {
    switch (this) {
      case ResponseStatusType.SUCCESS:
        return ServerFailure(statusCode: ResponseCode.SUCCESS, message: ResponseMessage.SUCCESS);
      case ResponseStatusType.NO_CONTENT:
        return ServerFailure(statusCode: ResponseCode.NO_CONTENT, message: ResponseMessage.NO_CONTENT);
      case ResponseStatusType.BAD_REQUEST:
        return ServerFailure(statusCode: ResponseCode.BAD_REQUEST, message: ResponseMessage.BAD_REQUEST);
      case ResponseStatusType.FORBIDDEN:
        return ServerFailure(statusCode: ResponseCode.FORBIDDEN, message: ResponseMessage.FORBIDDEN);
      case ResponseStatusType.UNAUTHORIZED:
        return ServerFailure(statusCode: ResponseCode.UNAUTHORIZED, message: ResponseMessage.UNAUTHORIZED);
      case ResponseStatusType.NOT_FOUND:
        return ServerFailure(statusCode: ResponseCode.NOT_FOUND, message: ResponseMessage.NOT_FOUND);
      ...
      case ResponseStatusType.CONNECT_TIMEOUT:
        return ServerFailure(statusCode: ResponseCode.CONNECT_TIMEOUT, message: ResponseMessage.CONNECT_TIMEOUT);
      case ResponseStatusType.CANCEL:
        return ServerFailure(statusCode: ResponseCode.CANCEL, message: ResponseMessage.CANCEL);
      case ResponseStatusType.RECEIVE_TIMEOUT:
        return ServerFailure(statusCode: ResponseCode.RECEIVE_TIMEOUT, message: ResponseMessage.RECEIVE_TIMEOUT);
      case ResponseStatusType.SEND_TIMEOUT:
        return ServerFailure(statusCode: ResponseCode.SEND_TIMEOUT, message: ResponseMessage.SEND_TIMEOUT);
      case ResponseStatusType.CACHE_ERROR:
        return ServerFailure(statusCode: ResponseCode.CACHE_ERROR, message: ResponseMessage.CACHE_ERROR);
      ...
      case ResponseStatusType.DEFAULT:
        return ServerFailure(statusCode: ResponseCode.DEFAULT, message: ResponseMessage.DEFAULT);
    }
  }
}