...
class LightThemeColors {
  ...
  // Primary Colors
  static const Color primary = Color(0xFF0B7BFF);
  ...
  static ThemeData getTheme() {
    ...
    return ThemeData(
      ...
      textTheme: TextTheme(
        // Display
        displayLarge:
            TextStylesManager.font.copyWith(color: LightThemeColors.primary),
        displayMedium: TextStylesManager.font
            .copyWith(color: LightThemeColors.primaryShade[80]),
        displaySmall: TextStylesManager.font
            .copyWith(color: LightThemeColors.tertiaryText),

        // Header
        headlineLarge:
            TextStylesManager.font.copyWith(color: LightThemeColors.error),
        headlineMedium:
            TextStylesManager.font.copyWith(color: LightThemeColors.success),
        headlineSmall:
            TextStylesManager.font.copyWith(color: LightThemeColors.warning),

        // Title
        titleLarge:
            TextStylesManager.font.copyWith(color: LightThemeColors.secondary),
        titleMedium:
            TextStylesManager.font.copyWith(color: LightThemeColors.greyShade),
        titleSmall:
            TextStylesManager.font.copyWith(color: LightThemeColors.onPrimary),

        // Body
        bodyLarge: TextStylesManager.font
            .copyWith(color: LightThemeColors.greyShade[50]),
        bodyMedium: TextStylesManager.font
            .copyWith(color: LightThemeColors.greyShade[45]),
        bodySmall: TextStylesManager.font
            .copyWith(color: LightThemeColors.greyShade[40]),

        // label
        labelLarge: TextStylesManager.font
            .copyWith(color: LightThemeColors.greyShade[38]),
        labelMedium: TextStylesManager.font
            .copyWith(color: LightThemeColors.greyShade[30]),
        labelSmall: TextStylesManager.font
            .copyWith(color: LightThemeColors.greyShade[26]),
      ),
      ...
      bottomNavigationBarTheme: BottomNavigationBarThemeData(
        ...
        selectedLabelStyle: TextStylesManager.font.regular.s10
            .setColor(LightThemeColors.selectedIcon),
        unselectedLabelStyle: TextStylesManager.font.regular.s10
      ...
      tabBarTheme: TabBarTheme(
        ...
        unselectedLabelStyle: TextStylesManager.font.s14.medium
            .setColor(LightThemeColors.tabBarText),
      ),
      ...
      dividerTheme: const DividerThemeData(
          thickness: 1, color: LightThemeColors.dividerColor),
      ...
      inputDecorationTheme: InputDecorationTheme(
        ...
        hintStyle: TextStylesManager.font.regular.s14.ellipsis
